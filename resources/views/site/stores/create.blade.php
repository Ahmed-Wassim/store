            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <ul class="breadcrumb-nav">
                        <li><a href="{{ route('stores.index') }}"><i class="lni lni-home"></i> Stores</a></li>
                        <li>Create</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                    <div class="register-form">
                        <form class="pt-3" action="{{ route('stores.store') }}" method="POST"
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="reg-desc" rows="12" name="description" required> </textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="image" type="file" id="reg-image" required>
                                </div>
                            </div>
                            @if ($errors->get('image'))
                                <ul class="fs-6 text-danger mt-2">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="video" type="text" id="reg-video" required>
                                </div>
                            </div>
                            @if ($errors->get('video'))
                                <ul class="fs-6 text-danger mt-2">
