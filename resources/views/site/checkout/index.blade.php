                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="text" name="addr[billing][phone]"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="text" name="addr[billing][postal_code]"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Phone Number</label>
                                                    <div class="form-input form">
                                                        <input type="text" name="addr[shipping][phone]"
                                                            placeholder="Phone Number">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Post Code</label>
                                                    <div class="form-input form">
                                                        <input type="text" name="addr[shipping][postal_code]"
                                                            placeholder="Post Code">
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="checkout-sidebar-price-table mt-30">
                            ...
                            <div class="sub-total-price">
                                <div class="total-price">
                                    ...
                                    <p class="price">{{ CurrencyHelper::format($cart->total()) }}</p>
                                </div>
