...
@push('styles')
    <style>
        ...
        .single-category ul ul {
            padding-left: 20px;
            /* Additional indent for subcategories */
        }
    </style>
@endpush
                    ...
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            @foreach ($sliders as $slider)
                                <!-- Start Single Slider -->
                                <div class="single-slider" style="background-image: url({{ $slider->image->path }});">
                                    <div class="content">
                                        <h2><span>{{ $slider->heading }}</span>
                                            {{ $slider->title }}
                                        </h2>
                ...
                <div class="col-lg-4 col-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                            <!-- Start Small Banner -->
                            <div class="hero-small-banner" style="background-image: url('{{ $vertical->image->path }}');">
                                <div class="content">
                                    <h2>
                                        <span>{{ $vertical->heading }}</span>
                                        {{ $vertical->title }}
                                    </h2>
                                    <div class="button">
                                        <a href="{{ $vertical->link }}" class="btn">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                            <!-- End Small Banner -->
                            ...
                            @if ($category->children->isNotEmpty())
                                <ul>
                                    @foreach ($category->children as $child)
                                        <li>
                                            <a href="{{ route('categories.show', $child->slug) }}">{{ $child->title }}</a>
                                            <!-- Recursive inclusion of children -->
                                            @include('site.partials.category-children', [
                ...
                <div class="col-lg-8 col-md-12 col-12">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-12">
                            ...
                            <div class="single-product">
                                <div class="product-image">
                                    <img src="{{ asset('site/assets/images/products/product-3.jpg') }}" alt="#">
                                    <div class="button">
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            ...
                            <div class="single-product">
                                <div class="product-image">
                                    <img src="{{ asset('site/assets/images/products/product-4.jpg') }}" alt="#">
                                    <div class="button">
                                        <a href="product-details.html" class="btn"><i class="lni lni-cart"></i>
                                            Add to
                                            Cart</a>
            ...
            <div class="row">
                    ...
                    <div class="single-blog">
                        <div class="blog-img">
                            <a href="blog-single-sidebar.html">
                                <img src="{{ asset('site/assets/images/blog/blog-1.jpg') }}" alt="#">
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-blog">
                        <div class="blog-img">
                            <a href="blog-single-sidebar.html">
                                <img src="{{ asset('site/assets/images/blog/blog-2.jpg') }}" alt="#">
                            </a>
                        </div>
                        <div class="blog-content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-blog">
                        <div class="blog-img">
                            <a href="blog-single-sidebar.html">
                                <img src="{{ asset('site/assets/images/blog/blog-3.jpg') }}" alt="#">
                            </a>
                        </div>
                        <div class="blog-content">
